...
@section('content')
    <div class="section search-result-wrap">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="heading">Category: Culture</div>
                </div>
            </div>
                ...
                <div class="col-lg-4 sidebar">
                    ...
                    <div class="sidebar-box">
                        ...
                        <ul class="tags">
                            ...
                            <li><a href="#">Adventure</a></li>
                            <li><a href="#">Food</a></li>
                            <li><a href="{{route('culture.page')}}">Lifestyle</a></li>
                            <li><a href="{{route('business.page')}}">Business</a></li>
                            <li><a href="#">Freelancing</a></li>
                        </ul>
                    </div>

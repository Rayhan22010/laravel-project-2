...
@section('content')
    <div class="section search-result-wrap">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="heading">Category: Politics</div>
                </div>
            </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="blog-entry d-flex blog-entry-search-item">
                        <a href="{{route('single_blog.page')}}" class="img-link me-4">
                            <img src="{{asset('upload/politicsImage/' . $data->image)}}" alt="Image" class="img-fluid">
                        </a>
                        <div>
                            <span class="date">{{$data->date_time}} &bullet; <a href="#">Politics</a></span>
                ...
                <div class="col-lg-4 sidebar">
                    ...
                    <div class="sidebar-box">
                        ...
                        <div class="post-entry-sidebar">
                            <ul>
                                @foreach ($popularPolitics as $data)
                                <li>
                                    <a href="{{route('single_blog.page')}}">
                                        <img src="{{asset('upload/politicsImage/' . $data->image)}}" alt="Image placeholder"
                                            class="me-4 rounded">
                                        <div class="text">
                                            <h4>{{$data->heading}}</h4>
                                            <div class="post-meta">

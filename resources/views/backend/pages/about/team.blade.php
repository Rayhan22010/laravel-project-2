    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{url('about_team_update')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('post')
            ...
            <table class="table table-striped table-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$data->heading}}</td>
                        <td style="width: 20rem">{{$data->description}}</td>
                        <td>
                            <button value="{{$data->id}}" class="btn btn-warning btn-sm editbtn"><i class="bi bi-pencil-square"></i></button>
                            <a href="{{route('about_team.delete',$data->id)}}" class="btn btn-danger btn-sm"><i class="bi bi-trash3"></i></a>
                        </td>
                    </tr>
                    @endforeach

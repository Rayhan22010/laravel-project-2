    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{url('backend_top_about_update')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('post')
...
<main id="main" class="main">
    <div class="container">
        <div class="align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">About <i class="bi bi-arrow-right-short"></i> top section</h1>
        </div>
        <form action="{{route('backend_top_about.store')}}" method="post" enctype="multipart/form-data"
            class="row g-3">
            @csrf
            <div class="col-12">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <img src="{{asset('upload/aboutImage/' . $data->image)}}" width="30px"
                                height="30px">
                        </td>
                        <td>{{$data->heading}}</td>
                        ...
                        <td>
                            ...
                            <a href="{{route('backend_top_about.delete',$data->id)}}" class="btn btn-danger btn-sm"><i class="bi bi-trash3"></i></a>
                        </td>
                    </tr>
                    @endforeach
...
<script>
    $(document).ready(function() {
        $(document).on('click', '.editbtn', function() {
            ...
            $.ajax({
                type: "GET",
                url: "/backend_top_about_edit/" + info_id,
                data: "data",

    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{url('bottom_right_update')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('post')
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" value="" class="form-control" id="icone"
                                aria-describedby="emailHelp" name="icone">
...
<main id="main" class="main">
    <div class="container">
        <div class="align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">About <i class="bi bi-arrow-right-short"></i> bottom right</h1>
        </div>
        <form action="{{route('bottom_right.store')}}" method="post" enctype="multipart/form-data"
            class="row g-3">
            @csrf
            <div class="col-md-6">
                <label for="icone" class="form-label">Icone</label>
                <input type="text" class="form-control" id="icone" name="icone" value="">
            </div>
            <div class="col-md-6">
                <label for="heading" class="form-label">Heading</label>
        ...
        <div class="row mt-5 table-responsive small">
            <table class="table table-striped table-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        <td> <span class="{!! $data->icone !!}"></span></td>
                        <td>{{$data->heading}}</td>
                        ...
                        <td>
                            ...
                            <a href="{{route('bottom_right.delete',$data->id)}}" class="btn btn-danger btn-sm"><i class="bi bi-trash3"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
...
<script>
    $(document).ready(function() {
        $(document).on('click', '.editbtn', function() {
            ...
            $.ajax({
                type: "GET",
                url: "/bottom_right_edit/" + info_id,
                data: "data",
                success: function(response) {
                    $('#icone').val(response.data.icone);

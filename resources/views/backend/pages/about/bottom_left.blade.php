    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{url('bottom_left_update')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('post')
...
<main id="main" class="main">
    <div class="container">
        ...
        <form action="{{route('bottom_left.store')}}" method="post" enctype="multipart/form-data"
            class="row g-3">
            @csrf
            <div class="col-12">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <img src="{{asset('upload/aboutImage/' . $data->image)}}" width="40px"
                                height="40px">
                        </td>
                        <td>{{$data->heading}}</td>
                        ...
                        <td>
                            ...
                            <a href="{{route('bottom_left.delete',$data->id)}}" class="btn btn-danger btn-sm"><i class="bi bi-trash3"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>

    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{url('culture_left_update')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('post')
...
<main id="main" class="main">
    <div class="container">
        <div class="align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Culture blog with picture</h1>
        </div>
        <form action="{{route('culture_left.store')}}" method="post" enctype="multipart/form-data"
            class="row g-3">
            @csrf
            <div class="col-12">
        ...
        <div class="row mt-5 table-responsive small">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{route('right_culture.delete',$data->id)}}" class="btn btn-danger btn-sm"><i class="bi bi-trash3"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
           ...
           {{$rcValue->links('pagination::bootstrap-5')}}
        </div>
    </div>
</main>
@endsection

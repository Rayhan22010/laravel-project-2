    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{url('left_business_update')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('post')
...
<main id="main" class="main">
    <div class="container">
        <div class="align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Left Business</h1>
        </div>
        <form action="{{route('left_business.store')}}" method="post" enctype="multipart/form-data"
            class="row g-3">
            @csrf
                    ...
                    @foreach ($bValue as $data)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('left_business.delete',$data->id)}}" class="btn btn-danger btn-sm"><i class="bi bi-trash3"></i></a>
                            </td>
                        </tr>
                        @endforeach
                </tbody>
...
<script>
    $(document).ready(function() {
        $(document).on('click', '.editbtn', function() {
            ...
            $.ajax({
                type: "GET",
                url: "/left_business_edit/" + info_id,
                data: "data",

    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{url('home_hero_update')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('post')
...
<main id="main" class="main">
    <div class="container">
        ...
        <form action="{{route('home_hero.store')}}" method="post" enctype="multipart/form-data"
            class="row g-3">
            @csrf
                    ...
                    @foreach ($value as $data)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('home_hero.delete',$data->id)}}" class="btn btn-danger btn-sm"><i class="bi bi-trash3"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
